...
function getMostVisitedPagesForPeriod(DateTime $startDate, DateTime $endDate, $maxResults = 20) {
...
function getVisitorsAndPageViewsForPeriod(DateTime $startDate, DateTime $endDate, $groupBy = 'date') {
    $analyticsData = [];

        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('company_contacts[]', $company_contacts, old('company_contacts') ? old('company_contacts') : $contact->company_contacts->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-company_contacts' ]) !!}
                    <p class="help-block"></p>
